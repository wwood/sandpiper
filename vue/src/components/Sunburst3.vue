...
<div>
  ...
  <svg id="dataviz_area" class="sunburst"></svg>
  </div>
</template>
...
export default {
  ...
  props: ['json_tree'],
  mounted () {
    this.sunburst(this.sunburst_data)
  },
  methods: {
    ...
    sunburst (sunburstData) {
      console.log('datax: ', sunburstData)
      const color = d3.scaleOrdinal(d3.quantize(d3.interpolateRainbow, 30))

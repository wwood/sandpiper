...
<template>
  <div>
    ...
    <section class="section is-small container has-text-justified">
      ...
      <p>For ease of interpretation and search, runs on this website are represented as a 'condensed' profile. These condensed profiles are a unified version of the profiles derived from each marker gene, so there is only one profile to inspect (instead of 59), though condensed profiles collapse the OTUs from each taxon into a single group.</p><br />

...
class NcbiMetadataExtraInfos:
    EXTRA_INFO = [
        ...
        ['acc', 'run', IDENTIFIERS_TYPE_METADATA, 'SRA Run accession in the form of SRR######## (ERR or DRR for INSDC partners)'],
        ...
        ['experiment_accession', 'experiment', IDENTIFIERS_TYPE_METADATA, 'The accession in the form of SRX######## (ERX or DRX for INSDC partners)'],
        ['sample_name', SAMPLE_INFO_TYPE_METADATA, 'Name of the sample'],
        ['model', SEQUENCING_TYPE_METADATA, 'Name of the sequencing instrument model'],
        ['library layout', 'library layout', SEQUENCING_TYPE_METADATA, 'Whether the data is SINGLE or PAIRED'],
        ['library selection', 'library selection', SEQUENCING_TYPE_METADATA, 'Library selection methodology (i.e. PCR, RANDOM, etc)'],
        ['library source', 'library source', SEQUENCING_TYPE_METADATA, 'Source of the biological data (i.e. GENOMIC, METAGENOMIC, etc)'],
        ['platform', SEQUENCING_TYPE_METADATA, 'Name of the sequencing platform (i.e. ILLUMINA)'],
        ['sample_accession', 'sample', IDENTIFIERS_TYPE_METADATA, 'SRA Sample accession in the form of SRS######## (ERS or DRS for INSDC partners)'],
        ['biosample', 'biosample', IDENTIFIERS_TYPE_METADATA, 'BioSample accession in the form of SAMN######## (SAMEA##### or SAMD##### for INSDC partners)'],
        ['taxon_name', 'organism / metagenome type', SAMPLE_INFO_TYPE_METADATA, 'Scientific name of the organism that was sequenced (as found in the NCBI Taxonomy Browser), or class of metagenome.'],
        ['study accession', 'sra study', IDENTIFIERS_TYPE_METADATA, 'SRA Study accession in the form of SRP######## (ERP or DRP for INSDC partners)'],
        ['releasedate', 'release date', CONTACT_TYPE_METADATA, 'The date on which the data was released'],
        ['bioproject', 'bioproject', IDENTIFIERS_TYPE_METADATA, 'BioProject accession in the form of PRJNA######## (PRJEB####### or PRJDB###### for INSDC partners)'],
        ...
        ['biosamplemodel', 'biosample model', SAMPLE_INFO_TYPE_METADATA, 'The BioSample package/model that was picked'],
        ['collection_date', 'collection date', SAMPLE_INFO_TYPE_METADATA, 'The collection date of the sample'],
        ...
        ['bases', SEQUENCING_TYPE_METADATA,'Number of sequenced bases.'],
        ['spots', SEQUENCING_TYPE_METADATA,'Number of reads.'],
    ]

...
if __name__ == '__main__':
    ...
    parent_parser.add_argument('--kingfisher-annotate-tsvs', help='CSV files generated by kingfisher annotate -f tsv', required=True, nargs='+')
    ...
    logging.info("Processing annotations from %d files" % (len(args.kingfisher_annotate_tsvs)))

    for path in args.kingfisher_annotate_tsvs:
